...
<head>
    ...
    <title>Message List | <?php echo BASE_TITLE;?></title>
    <!-- Favicon-->
	                        ...
	                        <?php 
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) { ?>
                                        <li class="<?php echo ($_GET['id'] == $row['id']) ? 'active' : '';?>">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                MESSAGES LIST
                                <small>list of project campaign</small>
                            </h2>
                        </div>
                        <div class="body table-responsive">
                            ...
                            <div class="row clearfix demo-button-sizes">
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
                                    <a href="message_form.php?id=<?php echo $_GET['id']?>"><button type="button" class="btn bg-red btn-block btn-lg waves-effect">Create Message</button></a>
                                </div>
                            </div>
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $result = $conn->query("SELECT * FROM messages where campaignID='".$_GET['id']."'");
                                        $counter = 1;
                                        if ($result->num_rows > 0) {
                                            // output data of each row
                                            while($row = $result->fetch_assoc()) { ?>
